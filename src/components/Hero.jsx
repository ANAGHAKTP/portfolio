    ...
    return (
        <section className="min-h-screen bg-forest text-cream overflow-hidden relative flex flex-col justify-center py-20 lg:py-28" id="home">
            ...
            <div className="absolute bottom-12 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center space-y-4 lg:hidden">
                <a href="#about" aria-label="Scroll down to About section" className="w-24 h-24 rounded-full border border-cream/20 flex items-center justify-center relative group active:border-mustard/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mustard">
            ...
            <div className="absolute bottom-10 right-20 hidden lg:block z-20">
                <a href="#about" aria-label="Scroll down to About section" className="w-32 h-32 rounded-full border border-cream/10 flex items-center justify-center relative group hover:border-mustard/30 transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-mustard">
                    <svg viewBox="0 0 100 100" aria-hidden="true" className="absolute inset-0 w-full h-full animate-spin-slow pointer-events-none">
