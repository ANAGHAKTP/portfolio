...
// ⚡ Bolt: Hoisted static Object.entries call outside component to prevent re-allocation on every render
const HIDDEN_FIELDS = contactData.contactForm.hiddenFields ? Object.entries(contactData.contactForm.hiddenFields) : [];
