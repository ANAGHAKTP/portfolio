...
export const aboutData = {
    image: "https://lh3googleusercontent.com/aida-public/AB6AXuBoyajx4hfeInTTyc5zhb8SeXlg7JZdkK4yQ8Y9iTEzuyGYGw7EUDNFTHrVFHC__yO7XASrCUHZOLBKzlqaN4VOnm4NwLYQzABrJk4c-Ioiq4bSgApP034wFh1zvmhpA1BA-rHLQANCdpu6lZ_h50Qgb1GDt3ARLIR5a-YiXwjj_w8ijTay3vvevQpr9R-lOf71CXnG3cOwJVDLvx9d9qFvdXUBCTYBYsJmo7D_f4WwGdaTVAhBOLydAu3b8T-fbH7_9jjnccV3zXWZ",
...
export const skillsData = [
    {
        title: "Languages",
        skills: ["Python", "Java", "C", "Flutter", "PHP"],
        color: "bg-accent-mint",
        rotate: "rotate-2",
    },
    {
        title: "Frameworks & Libs",
        skills: ["Django", "Flask", "React", "Node.js", "NumPy", "Pandas", "Scikit-learn", "TensorFlow"],
        color: "bg-accent-pink",
        rotate: "-rotate-1",
    },
    {
    ...
    },
    {
        ...
        skills: ["Git", "VS Code", "Jupyter", "Anaconda"],
        color: "bg-accent-lavender",
        rotate: "-rotate-2",
    },
    {
...
export const projectsData = [
    {
        ...
        tags: ["TensorFlow Lite", "Python", "NLP"],
        color: "bg-accent-mint",
...
export const contactData = {
    ...
    github: "https://github.com/ANAGHAKTP", // Replaced with generic or need to ask user. Using the repo link found in history (SudoAnirudh/portfolio) as a placeholder for now, or just '#'
    linkedin: "https://linkedin.com/in/anaghaktp", // Placeholder based on name
    socials: [
        { platform: "GitHub", url: "https://github.com/ANAGHAKTP", icon: "github" }, // Using user's github from URI
        { platform: "LinkedIn", url: "https://www.linkedin.com/in/anaghaktp/", icon: "linkedin" }
    ],
    contactForm: {
